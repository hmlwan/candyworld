						...
						<!--PAGE CONTENT BEGINS HERE-->
							...
							<input type="hidden"  name="id" value="<?php echo ($product["id"]); ?>">
								...
								<div class="control-group">
                                 ...
                                 <div class="control-group">
									<label class="control-label" for="stock"> 标签1</label>

									<div class="controls">
										<input type="text" value="<?php echo ($product["b1"]); ?>" name="b1" id="stock" placeholder="" />
									</div>
								</div>
                              
                              <div class="control-group">
									<label class="control-label" for="stock"> 标签2</label>

									<div class="controls">
										<input type="text" value="<?php echo ($product["b2"]); ?>" name="b2" id="stock" placeholder="" />
									</div>
								</div>
