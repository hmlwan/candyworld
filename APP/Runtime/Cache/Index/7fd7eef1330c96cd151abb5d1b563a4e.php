  ...
  <body class="framework7-root">
    ...
    <div class="navbar theme-white">
        <div class="navbar-inner">
            ...
            <div class="center" data-i18n="member.myinfo" style="left: -24px;color: #fff;">重置密码</div>
            <div class="right"></div>
        </div>
    </div>
...
<!--                     <li>
                ...
                <div class="area-10 center">
                    <a href="javascript:tryLogin();" class="r_but" idtype="myform1">
                        <img src="http://ae01.alicdn.com/kf/HTB1wcMWaxiH3KVjSZPf760BiVXaI.png" style="height:55px; width: auto">
                    </a>
                </div>
            </div>
        </form>
