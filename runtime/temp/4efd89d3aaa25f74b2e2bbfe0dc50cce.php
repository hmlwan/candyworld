<?php /*a:3:{s:65:"/www/wwwroot/www.wscorps.cn/application/index/view/member/wx.html";i:1523330544;s:67:"/www/wwwroot/www.wscorps.cn/application/index/view/layout/head.html";i:1523246924;s:69:"/www/wwwroot/www.wscorps.cn/application/index/view/layout/footer.html";i:1523246924;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="mui-content container setting">
    <form class="mui-input-group" action="<?php echo url('member/updateUser'); ?>" method="post" onsubmit="return false" id="submitForm">
        <div class="mui-input-row my-input-row">
            <label>账号</label>
            <input type="text" class="mui-input" placeholder="请输入微信账号" name="wx" value="<?php echo htmlentities($list->wx); ?>">
        </div>
        <input type="hidden" class="mui-input" id="wx_image_url" name="wx_image_url" value="<?php echo htmlentities($list->wx_image_url); ?>">
        <div class="mui-input-row my-input-row  upload">
            <img class="left" style="" src="/static/img/wechat.png">
            <span class="left">上传微信二维码</span>
        </div>
        <div class="white-box" style="padding: 10px;">
            <?php if($list->wx_image_url): ?>
				<img id="show" class="uploadFile" style="width: 100px;display: block;margin: auto;" src="<?php echo htmlentities($list->wx_image_url); ?>">
				<?php else: ?>
				<img id="show" class="uploadFile" style="width: 100px;display: block;margin: auto;" src="/static/img/tj.png">
			<?php endif; ?>
        </div>
        <input type="file" id="file" name="wx_image_url" style="display: none;">
    </form>
