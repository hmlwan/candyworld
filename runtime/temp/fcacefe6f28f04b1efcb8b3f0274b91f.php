<?php /*a:4:{s:62:"D:\wwwroot\web.4656.top\application\admin\view\user\magic.html";i:1587060486;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
            ...
            <div class="form-group">
                <div class="col-xs-1 no-pd-r">
                    <select name="type" class="form-control">
                        ...
                        <option <?php if(app('request')->get('type') == 2): ?> selected <?php endif; ?> value="2">购买工厂</option>
        ...
        <table class="table table-bordered table-striped no-margin">
            ...
            <?php if(!empty($list)): foreach($list as $entity): ?>
                ...
                <form class="form-horizontal" method="post" onsubmit="return false" role="form">
                    ...
                    <td class="text-center"><?php echo htmlentities($entity->create_time); ?></td>
                    </form>
                </tr>
                <?php endforeach; else: ?>
