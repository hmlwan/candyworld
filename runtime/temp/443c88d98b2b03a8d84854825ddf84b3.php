<?php /*a:4:{s:66:"/www/wwwroot/mojing/application/admin/view/user/certification.html";i:1523304526;s:59:"/www/wwwroot/mojing/application/admin/view/layout/main.html";i:1523304526;s:61:"/www/wwwroot/mojing/application/admin/view/layout/header.html";i:1523470910;s:59:"/www/wwwroot/mojing/application/admin/view/layout/left.html";i:1523304526;}*/ ?>
<!doctype html>
...
<section class="panel">
    <?php if($info->is_certification == -1 || $info->is_certification == 2): ?>
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <form class="form-horizontal" method="post" onsubmit="return false" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" value="<?php echo htmlentities($info->mobile); ?>" name="name" class="form-control">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" class="form-control" value="<?php echo htmlentities($info->nick_name); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" class="form-control" value="<?php echo htmlentities($info->real_name); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" class="form-control" value="<?php echo htmlentities($info->card_name); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" class="form-control" value="<?php echo htmlentities($info->card); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" class="form-control" value="<?php echo htmlentities($info->wx); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input readonly type="text" class="form-control" value="<?php echo htmlentities($info->zfb); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <img style="max-width: 100%" src="<?php echo htmlentities($info->card_right); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <img style="max-width: 100%" src="<?php echo htmlentities($info->card_left); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <textarea class="form-control" name="certification_fail"><?php echo htmlentities($info->certification_fail); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" data-url="<?php echo url('admin/user/certificationPass',['id'=>$info->id, 'status' => 1]); ?>"
                            onclick="main.ajaxPosts(this)" class="btn btn-primary">认证通过
                    </button>
                    <button type="submit" data-url="<?php echo url('admin/user/certificationPass',['id'=>$info->id, 'status' => 2]); ?>"
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <form class="form-horizontal" method="post" onsubmit="return false" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="<?php echo htmlentities($info->nick_name); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">真实姓名</label>
