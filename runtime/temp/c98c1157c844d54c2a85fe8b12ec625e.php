<?php /*a:4:{s:50:"F:\1000\application\admin\view\config\taskadd.html";i:1562903464;s:47:"F:\1000\application\admin\view\layout\main.html";i:1523246924;s:49:"F:\1000\application\admin\view\layout\header.html";i:1523413308;s:47:"F:\1000\application\admin\view\layout\left.html";i:1523246924;}*/ ?>
<!doctype html>
...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px" >
        <form class="form-horizontal" method="post" action="/admin/Config/taskadds" role="form" enctype="multipart/form-data">
        	<div class="form-group">
                <label class="col-sm-2 control-label">任务名称</label>

                <div class="col-sm-5">
                    <input type="text" value="" name="types" class="form-control"
                           placeholder="任务名称">
                </div>
            </div>
            <div class="form-group">
