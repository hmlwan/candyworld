<?php /*a:4:{s:63:"D:\wwwroot\web.4656.top\application\admin\view\group\index.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        ...
        <table class="table table-bordered table-striped no-margin">
            ...
            <tbody>
            <?php if($list): foreach($list as $entity): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php else: ?>
                                <a href="<?php echo url('group/edit',['id'=>$entity->getId()]); ?>" class="btn btn-xs btn-info">编辑</a>
                                <a data-url="<?php echo url('group/delete',['id'=>$entity->getId()]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要删除此分组吗？" class="btn btn-xs btn-danger">删除</a>
                                <a data-url="<?php echo url('group/force',['id'=>$entity->getId()]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要删除此分组和分组下面的用户吗？" class="btn btn-xs btn-danger">强制删除</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; else: ?>
