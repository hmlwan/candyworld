<?php /*a:4:{s:65:"D:\wwwroot\web.4656.top\application\admin\view\product\index.html";i:1587060486;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <!-- <form class="form-horizontal" action="">
            <div class="form-group">
                <div class="col-xs-3">
                    <input type="text" value="<?php echo htmlentities(app('request')->get('keyword')); ?>" name="keyword" class="form-control" placeholder="请输入会员昵称/电话号码搜索">
                </div>
        ...
        <table class="table table-bordered table-striped no-margin">
            ...
            <?php if(!empty($list)): foreach($list as $entity): ?>
                ...
                <form class="form-horizontal" method="post" onsubmit="return false" role="form">
                    ...
                    <td class="text-center"><img src="<?php echo htmlentities($entity->image_url); ?>" style="width: 80px;height: 80px;"></td>
                    <td class="text-center"><?php echo htmlentities($entity->product_name); ?></td>
                    <td class="text-center"><?php echo htmlentities($entity->rate_min); ?>kb/s-<?php echo htmlentities($entity->rate_max); ?>kb/s</td>
                    <td class="text-center"><?php echo htmlentities($entity->yield_min); ?>-<?php echo htmlentities($entity->yield_max); ?>糖果</td>
                    <td class="text-center"><?php echo htmlentities($entity->period); ?>天</td>
                    <td class="text-center"><?php echo htmlentities($entity->price); ?>糖果</td>
                    ...
                    <td class="text-center">
                        <a href="<?php echo url('product/edit',['id'=>$entity->id]); ?>" class="btn btn-xs btn-info">编辑</a>
                        <?php if($entity->status == 1): ?>
                            <a data-url="<?php echo url('product/shelve',['id'=>$entity->id]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要下架此工厂吗？" class="btn btn-xs btn-danger">下架</a>
                        <?php else: ?>
                            <a data-url="<?php echo url('product/downShelve',['id'=>$entity->id]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要上架此工厂吗？" class="btn btn-xs btn-success">上架</a>
                        <?php endif; ?>
                    </td>
                    </form>
                </tr>
