<?php /*a:4:{s:64:"D:\wwwroot\web.4656.top\application\admin\view\manage\index.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <form class="form-horizontal" action="">
            <div class="form-group">
                <div class="col-xs-3">
                    <input type="text" value="<?php echo htmlentities(app('request')->get('keyword')); ?>" name="keyword" class="form-control" placeholder="请输入用户名搜索">
                </div>
        ...
        <table class="table table-bordered table-striped no-margin">
            ...
            <?php if(!empty($list)): foreach($list as $entity): ?>
                <tr>
                    <td class="text-center"><?php echo htmlentities($entity->getCreateTime()); ?></td>
                    <td class="text-center"><?php echo htmlentities($entity->getName()); ?></td>
                    <td class="text-center">
                        <?php if($entity->isForbiddened()): ?>
                    ...
                    <td class="text-center">
                        <?php echo htmlentities($entity->getGroupName()); ?>
                    </td>
                    <td class="text-center">
                        <?php if($entity->isDefault()): ?>
                        <a class="btn btn-xs btn-danger">系统默认用户，不能修改</a>
                        <?php else: ?>
                                <a href="<?php echo url('manage/edit',['id'=>$entity->id]); ?>" class="btn btn-xs btn-info">编辑</a>
                            <?php if($entity->isForbiddened()): ?>
                                <a data-url="<?php echo url('manage/unforbidden',['id'=>$entity->id]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要解禁此用户吗？" class="btn btn-xs btn-success">解禁</a>
                            <?php else: ?>
                                <a data-url="<?php echo url('manage/delete',['id'=>$entity->id]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定要禁用此用户吗？" class="btn btn-xs btn-danger">禁用</a>
                            <?php endif; endif; ?>
                    </td>
                </tr>
                <?php endforeach; else: ?>
