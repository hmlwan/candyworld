<?php /*a:4:{s:63:"D:\wwwroot\web.4656.top\application\admin\view\config\task.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
...
<td class="text-center" style="vertical-align: middle; ">
                    ...
                    <?php echo htmlentities($config->types); ?>

                </td>
                <td class="text-center" style="vertical-align: middle; ">
                
                     <img src="<?php echo htmlentities($config->img); ?>" alt="" style="width:150px;">
                ...
                <td class="text-center" style="vertical-align: middle; ">
                    <a class="btn btn-xs btn-primary" href="/admin/Config/sladds2?id=<?php echo htmlentities($config->id); ?>">确认修改</a>

                     <a data-url="<?php echo url('Config/deletes2',['id'=>$config->id]); ?>" onclick="main.ajaxDelete(this)"
