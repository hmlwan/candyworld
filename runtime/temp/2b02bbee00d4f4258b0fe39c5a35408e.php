<?php /*a:4:{s:68:"/www/wwwroot/www.wscorps.cn/application/admin/view/index/change.html";i:1523413308;s:67:"/www/wwwroot/www.wscorps.cn/application/admin/view/layout/main.html";i:1523246924;s:69:"/www/wwwroot/www.wscorps.cn/application/admin/view/layout/header.html";i:1523413308;s:67:"/www/wwwroot/www.wscorps.cn/application/admin/view/layout/left.html";i:1523246924;}*/ ?>
<!doctype html>
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <form class="form-horizontal" method="post" onsubmit="return false" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="password" name="old_password" class="form-control" placeholder="原登录密码">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="password" name="password" class="form-control" placeholder="新登录密码">
                </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" data-url="<?php echo url('admin/index/updateInfo'); ?>"
