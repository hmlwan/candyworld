<?php /*a:4:{s:51:"F:\1000\application\admin\view\config\taskadds.html";i:1562903333;s:47:"F:\1000\application\admin\view\layout\main.html";i:1523246924;s:49:"F:\1000\application\admin\view\layout\header.html";i:1523413308;s:47:"F:\1000\application\admin\view\layout\left.html";i:1523246924;}*/ ?>
<!doctype html>
...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px" >
        <form class="form-horizontal" method="post" action="/admin/Config/taskddss2" role="form" enctype="multipart/form-data">
        	  <div class="form-group">
                <label class="col-sm-2 control-label">任务名称</label>

                <div class="col-sm-5">
                    <input type="text" value="<?php echo htmlentities($info['types']); ?>" name="types" class="form-control"
                           placeholder="任务名称">
                </div>
            </div>
