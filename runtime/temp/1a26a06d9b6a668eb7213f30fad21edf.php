<?php /*a:4:{s:66:"/www/wwwroot/mojing/application/admin/view/user/rechargemagic.html";i:1523384230;s:59:"/www/wwwroot/mojing/application/admin/view/layout/main.html";i:1523304526;s:61:"/www/wwwroot/mojing/application/admin/view/layout/header.html";i:1523470910;s:59:"/www/wwwroot/mojing/application/admin/view/layout/left.html";i:1523304526;}*/ ?>
<!doctype html>
...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        ...
        <input type="hidden" name="id" class="form-control" value="<?php echo htmlentities($info->id); ?>">
            <div class="form-group">
                <label class="col-sm-2 control-label">请选择工厂类型</label>

                <div class="col-sm-5">
                    <select name="product_id" class="form-control">
                        <?php foreach($productList as $productList): ?>
                        <option value="<?php echo htmlentities($productList->id); ?>"><?php echo htmlentities($productList->product_name); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" data-url="<?php echo url('admin/user/saveMagic',['id'=>$info->id]); ?>"
                            onclick="main.ajaxPosts(this)" class="btn btn-primary">确定充值
                    </button>
                </div>
            </div>
        </form>
