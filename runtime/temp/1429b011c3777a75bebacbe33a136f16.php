<?php /*a:4:{s:62:"D:\wwwroot\web.4656.top\application\admin\view\user\index.html";i:1587060335;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
            ...
            <?php if(!empty($list)): foreach($list as $entity): ?>
                <tr>
                    <td style="vertical-align: middle" class="text-center">
                        昵称：<?php echo htmlentities($entity->nick_name); ?>【<strong style="color: red"><?php echo htmlentities($entity->getLevel()); ?></strong>】<br>
                        账号：<?php echo htmlentities($entity->mobile); ?>
                    </td>
                    <td style="vertical-align: middle" class="text-center"><?php echo htmlentities($entity->invite_code); ?></td>
                    <td style="vertical-align: middle" class="text-center">
                        <?php if($entity->getParentInfo()): ?>
                            昵称：<?php echo htmlentities($entity->getParentInfo()['nick_name']); ?> <br>
                            账号：<?php echo htmlentities($entity->getParentInfo()['mobile']); ?> <br>
                        <?php else: ?>
                            无
                        <?php endif; ?>
                    </td>
                    <td style="vertical-align: middle" class="text-center">
                        人数：<?php echo htmlentities($entity->getTeamInfo()['total']); ?> 人 <br>
                        开采率：<?php echo htmlentities($entity->getTeamInfo()['rate']); ?> kb/s <br>
                    </td>
                    <td style="vertical-align: middle" class="text-center">
                    ...
                    <td style="vertical-align: middle" class="text-center">
                        时间：<?php echo htmlentities($entity->register_time); ?><br>
                        ip：<?php echo htmlentities($entity->register_ip); ?>
                    </td>
                    <td style="vertical-align: middle" class="text-center">
                    ...
                    <td style="vertical-align: middle" class="text-center">
                        ...
                        <a  href="<?php echo url('user/rechargemagic',['id'=>$entity->id]); ?>" class="btn btn-xs btn-info">充值工厂</a>
