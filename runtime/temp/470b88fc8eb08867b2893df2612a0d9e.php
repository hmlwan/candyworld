<?php /*a:4:{s:61:"/www/wwwroot/mojing/application/admin/view/user/recharge.html";i:1529209738;s:59:"/www/wwwroot/mojing/application/admin/view/layout/main.html";i:1523304526;s:61:"/www/wwwroot/mojing/application/admin/view/layout/header.html";i:1523470910;s:59:"/www/wwwroot/mojing/application/admin/view/layout/left.html";i:1523304526;}*/ ?>
<!doctype html>
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        ...
        <input type="hidden" name="id" class="form-control" value="<?php echo htmlentities($info->id); ?>">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" name="magic" class="form-control" placeholder="请输入充值晶石数量">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <textarea class="form-control" rows="3" name="remark">系统充值</textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" data-url="<?php echo url('admin/user/saveRecharge',['id'=>$info->id]); ?>"
