<?php /*a:4:{s:62:"D:\wwwroot\web.4656.top\application\admin\view\order\list.html";i:1587060486;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\main.html";i:1578457636;s:65:"D:\wwwroot\web.4656.top\application\admin\view\layout\header.html";i:1578457636;s:63:"D:\wwwroot\web.4656.top\application\admin\view\layout\left.html";i:1578457636;}*/ ?>
<!doctype html>
            ...
            <?php if($list): foreach($list as $order): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            昵称：<?php echo htmlentities($order->nick_name); ?><br>
                        ...
                        <td class="text-center">
                            <?php echo htmlentities($order->price); ?>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            ...
                            <?php if($order->status == 1 || $order->status == 2): ?>
                                <a class="btn btn-xs btn-danger" data-msg="确定要删除此订单吗" onclick="main.ajaxDelete(this)"  data-url="<?php echo url('order/delete',['id'=>$order->id]); ?>">删除订单</a>
